...
const btnHeaderPrimaryClass =
  "landing-header-btn landing-header-btn--primary landing-btn-interactive group inline-flex items-center justify-center gap-1.5 rounded-full bg-primary font-semibold text-primary-foreground no-underline transition-all hover:bg-primary-hover active:scale-[0.98]";

const btnHeaderSecondaryClass =
  "landing-header-btn landing-header-btn--secondary landing-btn-interactive inline-flex items-center justify-center rounded-full border font-semibold no-underline transition-all active:scale-[0.98]";
      ...
      >
        <div className="landing-header-bar__inner">
          <div className="landing-header-grid">
            ...
            <div className="landing-header-actions flex items-center gap-2.5 sm:gap-3">
              <Link
                href="/login"
