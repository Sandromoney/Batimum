...
import {
  LandingDeviceContext,
  LandingDeviceScene,
  type DeviceFocus,
} from "@/components/landing/landing-device-scene";
...
export function LandingHero() {
  ...
  const onFocusChange = useCallback((next: DeviceFocus) => setFocus(next), []);
      ...
      <div className="lp-container">
        <div className="lp-hero__grid">
          <div>
            ...
            <LandingDeviceContext focus={focus} />
          </div>

          <LandingDeviceScene onFocusChange={onFocusChange} />
        </div>
      </div>
    </section>
  );
